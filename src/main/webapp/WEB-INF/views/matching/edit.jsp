					...
					<div class="row uniform">
						<div class="6u 12u$(xsmall)">
							<input type="text" name="NAME" id="demo-name"
								value="${resultMap.NAME}" placeholder="Name" readonly />
						</div>
						<div class="6u$ 12u$(xsmall)">
							<input type="text" name="EMAIL" id="demo-email"
								value="${resultMap.EMAIL}" placeholder="Email" readonly />
						</div>
						...
						<div class="12u$">
							<textarea name="MESSAGE" id="demo-message"
								value="${resultMap.MESSAGE}" placeholder="Enter your message"
								rows="6"></textarea>
						</div>
						<div class="12u$">
							<ul class="actions">
