...
<article id="main">
	<header>
		...
		<p>JUST REGISTER YOUR GAME SCHEDULE AND INFORMATION OF YOUR TEAM. YOU CAN PLAY WITH NEW FRIENDS</p>
	</header>
			...
			<section>
				...
				<form method="post" action="<c:url value='/matching/insert' />">
					...
					<div class="row uniform">
						...
						<div class="12u$">
							<ul class="actions">
								<li><input type="submit" value="Register Matching" class="special" /></li>
